...
- **4 cities:** Vancouver (35 venues, 30 with photos), Dublin (35), Amsterdam (33, 19 with photos), Salt Lake City (35) — 138 total
...
- **2026-05-28:** Amsterdam OG image pipeline — added websiteUrl to 31/33 venues, ogImage to 19/33 venues via two passes (OG tags + hero image extraction from venue websites). Rejected logos, Google Photos TOS violations, broken URLs. Created CLAUDE_CONTEXT.md as cloud-backed memory. Saved TOS compliance rule to persistent memory.
