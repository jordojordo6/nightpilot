...
export const SLC_VENUES: Venue[] = [
  ...
  {id:414,name:"Cosmica",type:"restaurant",cuisine:"Italian",neighborhood:"Central 9th",price:3,rating:4.7,
    vibe:["trendy","creative","warm"],
    tags:["italian","trendy","creative","warm","wine","handmade-pasta","date-night"],
    emoji:"🌙",tagline:"NYT Best New Restaurant — inventive Italian in Central 9th",
    highlights:["NYT Best Restaurants 2025","Creative Italian","Natural wine list"],
    gradient:["#4E342E","#BCAAA4"],bestFor:"a standout Italian dinner that's earned national buzz",
    dietary:["vegetarian"],
    lat:40.7480,lng:-111.8990},
  ...
  {id:419,name:"Rouser",type:"restaurant",cuisine:"New American",neighborhood:"Downtown",price:3,rating:4.6,
    vibe:["upscale","creative","lively"],
    tags:["modern-american","upscale","creative","lively","charcoal-grilled","cocktails","date-night"],
    emoji:"🔥",tagline:"Charcoal-fired cooking in the historic Union Pacific Depot",
    highlights:["Historic train station","Josper charcoal grill","Asher Adams Hotel"],
    gradient:["#6A1B9A","#CE93D8"],bestFor:"an impressive dinner in one of SLC's most iconic buildings",
    dietary:["vegetarian","gluten-free"],
    lat:40.7694,lng:-111.9017},
  ...
  {id:461,name:"Eight Settlers Lounge",type:"bar",cuisine:"Distillery Bar",neighborhood:"Downtown",price:3,rating:4.5,
    vibe:["upscale","trendy","social"],
    tags:["distillery","upscale","trendy","social","craft-cocktails","lodge","date-night"],
    emoji:"🥃",tagline:"Multi-level distillery lounge with lodge vibes on Exchange Place",
    highlights:["House-distilled spirits","Multi-level lounge","Lodge-inspired design"],
    gradient:["#B71C1C","#FFCDD2"],bestFor:"craft spirits in a stylish new downtown lounge",
    dietary:[],
    lat:40.7619,lng:-111.8905},
  ...
  {id:465,name:"Prohibition",type:"bar",cuisine:"Speakeasy",neighborhood:"Murray",price:2,rating:4.3,
    vibe:["intimate","classic","fun"],
    tags:["speakeasy","intimate","classic","fun","craft-cocktails","late-night"],
    emoji:"🎩",tagline:"Underground speakeasy vibes with classic cocktails in Murray",
